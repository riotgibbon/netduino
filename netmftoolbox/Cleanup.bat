...
rem * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
rem * Copyright 2012 Stefan Thoolen (http://www.netmftoolbox.com/)            *
rem *                                                                         *
...
rem When compiling some samples, these files exist twice. Waste of space :)
del /s "Samples\Toolbox.NETMF.*"
