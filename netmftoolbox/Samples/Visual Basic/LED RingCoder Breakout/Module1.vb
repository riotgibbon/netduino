...
Module Module1
    ...
    Dim Led(0 To 15) As OutputPortShift
    ...
    Sub Main()
        ...
        Dim IcChain As Ic74HC595Chain = New Ic74HC595Chain(SPI_Devices.SPI1, Pins.GPIO_PIN_D10, 2)
        Dim Ic1 As Ic74HC595 = New Ic74HC595(IcChain, 0)
        Dim Ic2 As Ic74HC595 = New Ic74HC595(IcChain, 1)
        For Counter As Integer = 0 To 7
            Led(Counter) = New OutputPortShift(Ic1, CType(Counter, Ic74HC595.Pins), True)
            Led(Counter + 8) = New OutputPortShift(Ic2, CType(Counter, Ic74HC595.Pins), True)
        Next
